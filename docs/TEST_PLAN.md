...
| **AI 服务** | `http://127.0.0.1:7001/v1` (Qwen3.5-27B-4bit) |
| **文档数据** | MindInsight (45 files) + TechInsight (56 files) |
...
| 2 | 查看统计数据 | 总文档数显示 101，已读 0 |
| 3 | 滚动查看 MindInsight 分类 | 显示 4 个分类卡片（学术、电影、文学、哲学） |
| 4 | 滚动查看 TechInsight 分类 | 显示 7 个分类卡片（编程、AI/ML 等） |
| 5 | 点击"学术基础"分类 | 进入分类页，显示 22 篇文档 |
...
| PT-07 | 索引构建时间 (101 文档) | 构建耗时 | < 5s | P1 |
