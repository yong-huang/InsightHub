...
export const ACHIEVEMENTS: Achievement[] = [
  // Reading
  { id: 'first-read', name: 'First Read', description: 'Mark your first document as read', icon: 'BookOpen', color: '--accent-blue', category: 'reading' },
  { id: 'reader-10', name: 'Avid Reader', description: 'Read 10 documents', icon: 'BookOpen', color: '--accent-blue', category: 'reading' },
  { id: 'reader-50', name: 'Bookworm', description: 'Read 50 documents', icon: 'BookOpen', color: '--accent-blue', category: 'reading' },
  { id: 'reader-100', name: 'Reading Master', description: 'Read 100 documents', icon: 'BookOpen', color: '--accent-purple', category: 'reading' },
  { id: 'word-10k', name: 'Scholar', description: 'Read a total of 10,000 words', icon: 'FileText', color: '--accent-purple', category: 'reading' },
  { id: 'word-100k', name: 'Learned', description: 'Read a total of 100,000 words', icon: 'FileText', color: '--accent-purple', category: 'reading' },
  ...
  { id: 'quiz-10', name: 'Quiz Enthusiast', description: 'Complete 10 quizzes', icon: 'BrainCircuit', color: '--accent-purple', category: 'quiz' },
  { id: 'quiz-50', name: 'Quiz Marathoner', description: 'Complete 50 quizzes', icon: 'BrainCircuit', color: '--accent-red', category: 'quiz' },
  { id: 'perfect-score', name: 'Perfect Score', description: 'Get a perfect score (100%) on a quiz', icon: 'Sparkles', color: '--accent-yellow', category: 'quiz' },
  { id: 'high-scorer', name: 'High Achiever', description: 'Score 90+ on 3 consecutive quizzes', icon: 'Trophy', color: '--accent-yellow', category: 'quiz' },
  ...
  { id: 'first-comment', name: 'First Comment', description: 'Create your first comment annotation', icon: 'MessageSquare', color: '--accent-green', category: 'annotation' },
  { id: 'annotation-50', name: 'Annotation Pro', description: 'Create a total of 50 annotations', icon: 'MessageSquare', color: '--accent-green', category: 'annotation' },
  { id: 'annotation-100', name: 'Annotation Expert', description: 'Create a total of 100 annotations', icon: 'MessageSquare', color: '--accent-purple', category: 'annotation' },
  ...
  { id: 'streak-7', name: 'Weekly Warrior', description: 'Read for 7 consecutive days', icon: 'Flame', color: '--accent-orange', category: 'streak' },
  { id: 'streak-30', name: 'Monthly Devotee', description: 'Read for 30 consecutive days', icon: 'Flame', color: '--accent-red', category: 'streak' },
  { id: 'explorer', name: 'Explorer', description: 'Explore multiple sources (MindInsight + TechInsight + LeetcodeInsight)', icon: 'Compass', color: '--accent-blue', category: 'streak' },
  ...
  { id: 'early-bird', name: 'Early Bird', description: 'Read between 5 AM and 8 AM', icon: 'Sun', color: '--accent-yellow', category: 'special' },
  { id: 'all-day-reader', name: 'All-Day Reader', description: 'Read during three different time periods (morning/afternoon/evening)', icon: 'Clock', color: '--accent-purple', category: 'special' },
