...
export type FeatureKey = 'aiSummary' | 'aiInception' | 'aiEvaluation' | 'aiQuiz' | 'aiConcept' | 'aiSimilarity' | 'aiScript'

const ALL_FEATURES: FeatureKey[] = ['aiSummary', 'aiInception', 'aiEvaluation', 'aiQuiz', 'aiConcept', 'aiSimilarity', 'aiScript']
